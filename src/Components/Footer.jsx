        ...
        <div className="container">
            <div className="lg:grid lg:grid-cols-2">
                <div className="mb-10">
                    ...
                    <ButtonPrimary href="mailto:imgoncalosilva18@gmail.com" label="Start project" icon="chevron_right" classes="reveal-up" />
                </div>
            ...
            <div className="flex items-center justify-between pt-10 mb-8">
                ...
                <p className="text-zinc-500 text-sm">&copy; 2024 <span className="text-zinc-200">Gonçalo Silva</span></p>
            </div>
        </div>
    </footer>
  )

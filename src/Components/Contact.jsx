...
const socialLinks = [
    {
      href: 'https://www.github.com/goncalosilvaa',
    ...
    {
      href: 'https://www.linkedin.com/in/goncalosilvaa18',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg-max-w-[30ch] reveal-up">
                    React out today to discuss your project needs and start collaborationg on something amazing!
                </p>
            ...
            <form action="https://getform.io/f/bgdymwva" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label reveal-up">Name</label>
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Gonçalo Silva" className="text-field reveal-up" />
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label reveal-up">Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="goncalo@example.com" className="text-field reveal-up" />
                        </div>
                    </div>

                    <div className="mb-4">
                            <label htmlFor="subject" className="label reveal-up">Subject</label>
                            <select type="subject" name="subject" id="subject" required placeholder="Choose your subject" className="text-field reveal-up">
